...
public class StringExperiment {
  ...
  public static void main(String[] args) {
    ...
    for (int t = 0; t < trials; t++) {
      ...
      System.out.println(String.format("n: %9d took %12d milliseconds", n,
          elapsed));
    ...
    // public static void main(String[] args) {
    // long startTime = System.currentTimeMillis();
    // String temp = repeat1('-', 10000);
    // long endTime = System.currentTimeMillis();
    // long elapsed = endTime - startTime;
    // System.out.println(String.format("n: %9d took %12d milliseconds", 10000,
    // elapsed));
    ...
    // System.out.println(String.format("Algorithm 2 n: %9d took %12d milliseconds",
    // 10000, elapsed1));
    // }
  }
}
